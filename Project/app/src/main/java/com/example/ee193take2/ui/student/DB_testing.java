...
public class DB_testing extends Fragment {

    private StudentViewModel mViewModel;

    public static DB_testing newInstance() {
        return new DB_testing();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_d_b_testing, container, false);
    }
